---
title: Adding Your Own Content To W.B.
date: 2020-07-24 23:45:00 Z
categories:
- articles
- tutorials
tags:
...
The reason why this field cannot be anything you want is that the categories you set will show up in the URL. Take a look at this article's URL. What you should see is aspiring-writer.github.io/articles/tutorials/adding-your-own-content-to-wb. The categories for this post are "articles", and "tutorials". Do you see what I mean by the categories affect the post's URL? Whatever categories you set will be reflected in the URL between the site's name and your post's title. They should not be changed.
